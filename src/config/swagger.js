...
const definition = {
  ...
  tags: [
    ...
    { name: 'Invoices', description: 'Billing records generated when a consultation is completed' },
    { name: 'Payments', description: 'Cashier payments against invoices' },
  ],
  security: [{ bearerAuth: [] }],
  components: {
    securitySchemes: {
    ...
    schemas: {
      ...
      Invoice: {
        ...
        properties: {
          ...
          totalAmount: { type: 'number', format: 'float', example: 5000 },
